...
/dev/nvme0n1p2 -> /boot/tpm -> LUKS passphrase for /dev/nvme0n1p4. Unlocked with TPM attestation. <br />
/dev/nvme0n1p3 -> /boot/fido2 -> LUKS header for /dev/nvme0n1p4. Unlocked with with FIDO2. <br />
/dev/nvme0n1p4 -> / <br />
